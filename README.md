...
The Butterfly Launcher injects custom code into a custom Fortnite client, which antivirus software generally believes to be malicious.
To prevent Windows from deleting the Butterfly Launcher or causing other issues, you can add an exclusion for it in Windows Security.<br><br>
...
• Wear the skin you select from the lobby in-game<br>
